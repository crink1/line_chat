...
int main(int argc, char *argv[])
{
    ...
    crin_lc::TransmitServerBuilder tsb;
    tsb.make_mq_object(FLAGS_mq_user,
                       FLAGS_mq_pswd,
                       FLAGS_mq_host,
    ...
    tsb.make_mysql_object(FLAGS_mysql_user,
                          FLAGS_mysql_pswd,
                          FLAGS_mysql_host,
                          FLAGS_mysql_db,
                          FLAGS_mysql_cset,
    ...
    tsb.make_discovery_object(FLAGS_registry_host,
                              FLAGS_base_service,
                              FLAGS_user_service);

    tsb.make_rpc_server(FLAGS_listen_port,
                        FLAGS_rpc_timeout,
                        FLAGS_rpc_threads);
