...
#include "mysql_message.hpp" //mysql数据管理客户端
#include "channel.hpp"
...
namespace crin_lc
{
    class MessageServiceImpl : public crin_lc::MsgStorageService
    {
    public:
        MessageServiceImpl(
        ...
        virtual void GetHistoryMsg(::google::protobuf::RpcController *controller,
                                   const ::crin_lc::GetHistoryMsgReq *request,
                                   ::crin_lc::GetHistoryMsgRsp *response,
        ...
        virtual void GetRecentMsg(::google::protobuf::RpcController *controller,
                                  const ::crin_lc::GetRecentMsgReq *request,
                                  ::crin_lc::GetRecentMsgRsp *response,
                                  ::google::protobuf::Closure *done)
        {
            brpc::ClosureGuard rpc_guard(done);
            auto err_response = [this, response](const std::string &rid,
        ...
        virtual void MsgSearch(::google::protobuf::RpcController *controller,
                               const ::crin_lc::MsgSearchReq *request,
                               ::crin_lc::MsgSearchRsp *response,
                               ::google::protobuf::Closure *done)
        {
            brpc::ClosureGuard rpc_guard(done);
            auto err_response = [this, response](const std::string &rid,
        ...
        void onMessage(const char *body, size_t sz)
        {
            ...
            crin_lc::Message msg(message.message_id(),
                                 message.chat_session_id(),
                                 message.sender().user_id(),
