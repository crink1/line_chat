...
namespace crin_lc
{
    ...
    public:
        ...
        void append(const std::string &cid, const std::string &code, const std::chrono::milliseconds &timeout = std::chrono::milliseconds(300000))
        {
            _redis_client->set(cid, code, timeout);
        }
